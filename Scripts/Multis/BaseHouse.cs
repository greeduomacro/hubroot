...
namespace Server.Multis
{
    public abstract class BaseHouse : BaseMulti
    {
        ...
        public virtual TimeSpan DecayPeriod { get { return TimeSpan.FromDays(11.0); } }
        ...
        public virtual bool IsAosRules { get { return Core.ML; } }
        ...
        public virtual bool IsInside( Point3D p, int height )
        {
            ...
            {
                if( multi != this
                    && multi is Knives.TownHouses.TownHouse
                    && ((Knives.TownHouses.TownHouse)multi).ForSaleSign is Knives.TownHouses.RentalContract
                    && ((Knives.TownHouses.TownHouse)multi).IsInside(p, height) )
                    return false;
            }
