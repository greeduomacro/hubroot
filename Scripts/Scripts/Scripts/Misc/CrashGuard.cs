...
namespace Server.Misc
{
	public class CrashGuard
	{
		...
		private static void SendEmail( string filePath )
		{
			...
			MailMessage message = new MailMessage( "UOServer", Email.CrashAddresses );
			message.Subject = "Automated crash report e-mail";
			message.Body = "See attached crash report for details.";
