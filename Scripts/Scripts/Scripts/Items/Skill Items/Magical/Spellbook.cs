    ...
    public class Spellbook : Item, ICraftable, ISlayer
    {
        ...
        private static void EventSink_OpenSpellbookRequest( OpenSpellbookRequestEventArgs e )
        {
            ...
            switch( e.Type )
            {
                ...
                case 3: type = SpellbookType.Arcanist; break;
                case 4: type = SpellbookType.Divine; break;
            }
        ...
        public static SpellbookType GetTypeForSpell( int spellID )
        {
            ...
            else if( spellID >= 700 && spellID < 708 )
                return SpellbookType.Divine;
        ...
        public override void GetProperties( ObjectPropertyList list )
        {
            ...
            {
                if( m_Crafter != null )
                    list.Add( 1050043, m_Crafter.Name );

                list.Add( 1042886, m_Count.ToString() );
