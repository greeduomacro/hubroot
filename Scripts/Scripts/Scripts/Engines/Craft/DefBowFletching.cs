...
namespace Server.Engines.Craft
{
    public class DefBowFletching : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            // Weapons
            AddCraft(typeof(PracticeBow), 1044566, "practice bow", 25.0, 65.0, typeof(Log), 1044041, 5, 1044351);
            AddCraft(typeof(Bow), 1044566, 1025042, 30.0, 70.0, typeof(Log), 1044041, 7, 1044351);
            AddCraft(typeof(PracticeXBow), 1044566, "practice crossbow", 25.0, 65.0, typeof(Log), 1044041, 5, 1044351);
            AddCraft(typeof(Crossbow), 1044566, 1023919, 60.0, 100.0, typeof(Log), 1044041, 7, 1044351);
            AddCraft(typeof(HeavyCrossbow), 1044566, 1025117, 80.0, 110.0, typeof(Log), 1044041, 10, 1044351);

            if( Core.AOS )
            {
                AddCraft(typeof(CompositeBow), 1044566, 1029922, 70.0, 110.0, typeof(Log), 1044041, 7, 1044351);
                AddCraft(typeof(RepeatingCrossbow), 1044566, 1029923, 80.0, 115.0, typeof(Log), 1044041, 10, 1044351);
            }

            AddCraft(typeof(ElvenCompositeLongbow), 1044566, 1031562, 75.0, 105.0, typeof(Log), 1044041, 18, 1044351);

            index = AddCraft(typeof(Server.Items.Quiver), 1015283, "Quiver", 80.0, 100.0, typeof(Leather), 1044462, 8, 1044463);
            AddRes(index, typeof(Board), 1027799, 1, 1042598);
            AddSkill(index, SkillName.Tailoring, 65.0, 90.0);
