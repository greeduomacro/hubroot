...
namespace Server.Engines.Craft
{
    public class DefBlacksmithy : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            #region Platemail
            AddCraft(typeof(PlateArms), 1011078, 1025136, 66.3, 111.3, typeof(IronIngot), 1044036, 18, 1044037);
            AddCraft(typeof(PlateGloves), 1011078, 1025140, 58.9, 103.9, typeof(IronIngot), 1044036, 12, 1044037);
            AddCraft(typeof(PlateGorget), 1011078, 1025139, 56.4, 101.4, typeof(IronIngot), 1044036, 10, 1044037);
            AddCraft(typeof(PlateLegs), 1011078, 1025137, 68.8, 113.8, typeof(IronIngot), 1044036, 20, 1044037);
            AddCraft(typeof(PlateChest), 1011078, 1046431, 75.0, 115.0, typeof(IronIngot), 1044036, 25, 1044037);
            AddCraft(typeof(FemalePlateChest), 1011078, 1046430, 44.1, 89.1, typeof(IronIngot), 1044036, 20, 1044037);

            if( Core.AOS ) // exact pre-aos functionality unknown
                AddCraft(typeof(DragonBardingDeed), 1011078, 1053012, 72.5, 117.5, typeof(IronIngot), 1044036, 750, 1044037);
            #endregion
            ...
            if( Core.AOS )
            {
                AddCraft(typeof(ChaosShield), 1011080, 1027107, 75.0, 125.0, typeof(IronIngot), 1044036, 25, 1044037);
                AddCraft(typeof(OrderShield), 1011080, 1027108, 75.0, 125.0, typeof(IronIngot), 1044036, 25, 1044037);
            }
            #endregion

            #region Bladed

            //AddCraft(typeof(PracticeBroadsword), 1011081, "practice broadsword", 25.0, 65.0, typeof(IronIngot), 1044036, 8, 1044037);
            ...
            //AddCraft(typeof(PracticeDagger), 1011081, "practice dagger", 25.0, 65.0, typeof(IronIngot), 1044036, 6, 1044037);
            ...
            #region Axes
            //AddCraft(typeof(PracticeBattleaxe), 1011082, "practice battleaxe", 25.0, 65.0, typeof(IronIngot), 1044036, 10, 1044037);
            ...
            //AddCraft(typeof(PracticeSpear), 1011083, "practice spear", 25.0, 65.0, typeof(IronIngot), 1044036, 9, 1044037);
            ...
            #region Bashing
            //AddCraft(typeof(PracticeMace), 1011084, "practice mace", 25.0, 65.0, typeof(IronIngot), 1044036, 4, 1044037);
            //AddCraft(typeof(PracticeMaul), 1011084, "practice maul", 25.0, 65.0, typeof(IronIngot), 1044036, 7, 1044037);
