...
namespace Server.Misc
{
    public class RegenRates
    {
        ...
        public static void Configure()
        {
            ...
            Mobile.DefaultStamRate = TimeSpan.FromSeconds( 10.0 );
        ...
        private static TimeSpan Mobile_ManaRegenRate( Mobile from )
        {
            ...
            if( Core.AOS )
            {
                ...
                if (from is Player)
                {
                    if (((Player)from).Race == Race.Elemental && ((Player)from).AbilityActive == true)
                    {
                        medPoints += 24;
                    }
                    ...
                    if (bmr != null)
                        medPoints += bmr.MasterRegenBonus();
                }
