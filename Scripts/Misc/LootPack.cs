        ...
        private static readonly LootPack AosUltraRich = new LootPack(new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 2, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 2, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 2, 5, 25, 150 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 2, 5, 35, 150 ),
        ...
        private static readonly LootPack AosSuperBoss = new LootPack(new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 1, 5, 33, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 1, 5, 33, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 1, 5, 33, 150 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 2, 5, 50, 200 ),
