...
namespace Server.Items
{
    public abstract class Food : Item
    {
        ...
        public virtual bool Eat( Mobile from )
        {
            ...
            if( FillHunger(from, m_FillFactor) )
            {
                ...
                if( from.Player )
                {
                    EventDispatcher.InvokePlayerEating(new PlayerEatingEventArgs((Player)from, this));
                }
                ...
                case 5:
                    {
                        ...
                        if( type != null )
                            m_SeedType = ScriptCompiler.FindTypeByFullName(type);
                        goto case 4;
                    }
            }
        }
    ...
    {
        public override Type SeedType { get { return typeof(HoneydewMelonSeed); } }
    ...
    {
        public override Type SeedType { get { return typeof(CornSeed); } }
    ...
    {
        public override Type SeedType { get { return typeof(TurnipSeed); } }
