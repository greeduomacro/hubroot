...
namespace Server.Engines.Craft
{
	public class DefCarpentry : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( Drawer ),						1044292, "drawer",	52.1,  81.8,	typeof( Log ), 1044041, 20, 1044351 );
			AddCraft( typeof( FancyDrawer ),		  1044292, "fancy drawer",	52.1,  81.8,	typeof( Log ), 1044041, 25, 1044351 );
			AddCraft( typeof( FullBookcase ),		  1044292, "full bookcase",	49.6,  92.1,	typeof( Log ), 1044041, 30, 1044351 );
