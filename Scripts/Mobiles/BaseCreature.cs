        ...
        public virtual void OnThink()
        {
            if (CreatureAlignment == Alignment.None)
            {
                if (Karma > -8000 && Karma < -2000)
                    CreatureAlignment = Alignment.Chaotic;

                if (Karma > 2000 && Karma < 8000)
                    CreatureAlignment = Alignment.Lawful;

                if (Karma > -1999 && Karma < 1999)
                    CreatureAlignment = Alignment.Neutral;

                if (Karma <= -8000)
                    CreatureAlignment = Alignment.Evil;

                if (Karma >= 8000)
                    CreatureAlignment = Alignment.Good;
            }
