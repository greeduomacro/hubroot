...
namespace Server.Mobiles
{
	public class EtherealMount : Item, IMount, IMountItem
	{
		...
		public virtual int FollowerSlots { get { return 2; } }
		...
		{
            if (((Player)m_Rider).Race == Race.Elemental && this.GetType() == typeof(EtherealSeaHorse))
            {
                this.Consume();
            }
	...
	public class EtherealHellsteed : EtherealMount
	{
		...
		public EtherealHellsteed( Serial serial )
			: base( serial )
		{
		}
	...
	{
		[Constructable]
		public EtherealSeaHorse()
			: base( 0x211F, 0x3EB3 )
		{
			Name = "an ethereal seahorse";
		}
		...
		public EtherealSeaHorse( Serial serial )
			: base( serial )
		{
		}
